...
<body>
    ...
    <a href="AgregarRol.jsp" class="btn_crear">Crear Rol</a>
...
%>
        ...
        <td>
                    <a href="rol?action=edit&id=<%= r.getId_rol() %>"><img src="img/icono_editar.png" alt="Modificar" width="20" height="20"/></a>
                    <a href="rol?action=delete&id=<%= r.getId_rol() %>" onclick="return confirm('¿Estás seguro de que deseas eliminar el rol <%= r.getNombre_rol() %> ?')"><img src="img/icono_eliminar.png" alt="Eliminar" width="20" height="20"/></a>
                </td>    
        </tr>
<%
        }
